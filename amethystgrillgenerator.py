...
videos = ['<iframe width="560" height="315" src="https://www.youtube.com/embed/OYxnqhb_Eis" frameborder="0" allowfullscreen></iframe>']
boldwords = {
...
<link rel="stylesheet" type="text/css" href="style.css" media="screen"/>
   ...
   var _paq = _paq || [];
   _paq.push(["setDomains", ["*.amethystgrills.com","*.trinitysoulstars.github.io/amethystgrills.com"]]);
   ...
   <noscript><p><img src="//piwik-decause.rhcloud.com/piwik.php?idsite=8" style="border:0;" alt="" /></p></noscript>
   <!-- End Piwik Code -->
